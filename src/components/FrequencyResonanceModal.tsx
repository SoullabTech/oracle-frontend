const frequencyMapping = {
    tenderness: { label: "Heart Healing 528Hz", url: "https://www.youtube.com/watch?v=528HzHealingSound" },
    excitement: { label: "Manifestation 963Hz", url: "https://www.youtube.com/watch?v=963HzManifest" },
