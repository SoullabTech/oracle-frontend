...
export type SpiralBreathState = {
  ...
  export function detectSpiralBreath(input: string): SpiralBreathState {
    ...
    if (lowerInput.includes("dream") || lowerInput.includes("lost") || lowerInput.includes("forgot")) axis = "Subconscious";
    if (lowerInput.includes("mystery") || lowerInput.includes("eternal") || lowerInput.includes("source")) axis = "Meta-Conscious";
    if (lowerInput.includes("blank") || lowerInput.includes("numb") || lowerInput.includes("can't feel")) axis = "Unconscious";
